...
import 'package:contact/Components/color.dart';
import 'package:contact/Onboarding/onboarding_items.dart';

import '../read_contacts.dart';
    ...
    return Container(
      ...
      child: TextButton(
          onPressed: ()async{
            ...
            // same key
            if(!mounted)return;
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ReadContacts()));
          },
